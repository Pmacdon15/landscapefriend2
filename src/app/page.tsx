    ...
    <div className="flex-1 flex flex-col">
      ...
      <section className="relative w-full overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-start gap-6 px-6 py-24 md:py-36">
          ...
          <h1 className="max-w-3xl text-balance text-5xl font-extrabold tracking-tight text-foreground drop-shadow-sm md:text-7xl">
            Run your landscaping business from one clean dashboard
          </h1>
          <p className="max-w-xl text-pretty text-lg font-medium leading-relaxed text-foreground/85 drop-shadow-sm">
